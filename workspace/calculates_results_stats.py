...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic :
        #labels match exactly, number of matches between pet & classifier labels
        if results_dic[key][2] == 1:
            n_match += 1
        #Pet image label is a dog number of dog images
        if results_dic[key][3] == 1:
            n_dogs_img += 1
        #Pet image is dog and classifier too -- number of correctly classified dog images
